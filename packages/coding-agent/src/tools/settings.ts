...
export const cfgToolRouterEnabled = register({
	id: "toolRouter.enabled",
	type: "boolean",
	default: false,
	ui: {
		tab: "tools",
...
export const cfgToolRouterMinConfidence = register({
	id: "toolRouter.minConfidence",
	type: "number",
	default: 0.7,
});

export const cfgToolRouterTimeoutMs = register({
	id: "toolRouter.timeoutMs",
	type: "number",
	default: 1500,
});
